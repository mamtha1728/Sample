   ...
   <xsl:template match="/">
      <xsl:for-each select="/imp1:SSACompositeRequest">
         <imp1:SSACompositeResponse>
            <xsl:if test="ns0:SSACompositeIndividualRequest/@ns2:id">
               <xsl:attribute name="ns2:id">
                  <xsl:value-of select="ns0:SSACompositeIndividualRequest/@ns2:id"/>
               </xsl:attribute>
            </xsl:if>
            <xsl:if test="ns0:SSACompositeIndividualRequest/@ns2:metadata">
               <xsl:attribute name="ns2:metadata">
                  <xsl:value-of select="ns0:SSACompositeIndividualRequest/@ns2:metadata"/>
               </xsl:attribute>
            </xsl:if>
            <xsl:if test="ns0:SSACompositeIndividualRequest/@ns2:linkMetadata">
               <xsl:attribute name="ns2:linkMetadata">
                  <xsl:value-of select="ns0:SSACompositeIndividualRequest/@ns2:linkMetadata"/>
               </xsl:attribute>
            </xsl:if>
